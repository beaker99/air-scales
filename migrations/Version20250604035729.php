 ...
 */
final class Version20250604035729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_dcbb0c538e5cc2c0 ON device
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_DCBB0C538E5CC2C0 ON device (sold_to_id)
        SQL);
        $this->addSql(<<<'SQL'
